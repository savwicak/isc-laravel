...
<!-- Vendor CSS Files -->
  ...
  <link href="{{ asset('front-end_asset/assets/css/style.css') }}" rel="stylesheet">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              <strong>Email:</strong> iscjuniorhs@gmail.com<br>
            </p>
...
<script src="{{ asset('front-end_asset/assets/js/main.js') }}"></script>